...
---
This has been a prodigious year for generating new funded collaborations between Protocol Research and top academic researchers around the world! We have given out a whopping eighteen awards since August (with others pending). These include eight RFPs, five PhD fellowships, three Postdoctoral fellowships, one implementation grant, and a faculty nucleation award. We’ll be detailing these awards in two separate blog posts. This first installment is to announce the RFP award recipients as well as a new funded collaboration with Prof Nada Amin of Harvard University. PL Research’s Requests for Proposals (RFPs) are designed to fund goal-driven research in response to specific open problems defined by Protocol Labs. RFPs are posted intermittently based on need and the readiness of our research labs to support these collaborations. You can view previous RFPs here. Below, you will find descriptions of our award recipients: two proposals for RFP-000, two for RFP-009, and four for RFP-010. 

If you are interested in hearing about future RFP opportunities, please [subscribe to our newsletter](https://mailchi.mp/protocol/research-newsletter-signup). 

# RFP-000

## Federated learning on IPFS
#### [Dimitris Chatzopoulos](https://seng.hkust.edu.hk/about/people/faculty/dimitrios-chatzopoulos) (HKUST), [Spyros Lalis](https://faculty.e-ce.uth.gr/lalis/), Eleni Panagou, and Christodoulous Pappas (University of Thessaly) 
...
#### [Leonhard Balduf](https://www.weizenbaum-institut.de/en/portrait/p/leonhard-balduf/), [Martin Florian](https://www.weizenbaum-institut.de/en/portrait/p/martin-florian/), [Sebastian Henningsen](https://www.weizenbaum-institut.de/en/portrait/p/sebastian-henningsen/), [Björn Scheuermann](https://fonda.hu-berlin.de/partners/prof-bjorn-scheuermann/) (Humboldt University Berlin/Weizenbaum Institute)
...
#### [Giuseppe Ateniese](https://www.gmu.edu/node/52511) (George Mason University), Long Chen (Insititute of Software, Chinese Academy of Sciences), Danilo Francati (Aarhus University), [Dimitris Papadopoulos](https://seng.hkust.edu.hk/about/people/faculty/dimitris-papadopoulos) (HKUST), [Qiang Tang](https://alkistang.github.io/) (University of Sydney)
...
#### [Carla Rafols](https://www.upf.edu/web/etic/entry/-/-/127288/adscripcion/carla-rafols) and Alexandros Zacharakis (Universitat Pompeu Fabra) 
...
#### Team: Russell Lai and Sri Aravinda Krishnan Thyagarajan (Friedrich-Alexander University Erlangen-Nuremberg); Martin Albrecht (Royal Holloway, University of London); Giulio Malavolta (Max Planck Institute for Security and Privacy)
...
#### [Charalampos (Babis) Papamanthou](https://www.cs.yale.edu/homes/cpap/) (Yale) 
