...
help:
	@echo 'Makefile for a protocol.ai, a hugo built static site.                                                          '
	@echo '                                                                                                          '
	@echo 'Usage:                                                                                                    '
...
js: install
	$(PREPEND)$(NPMBIN)/browserify --noparse=jquery js/{about,blog,join,legal,media,projects,team}.js -p [ factor-bundle -o static/js/about.js -o static/js/blog.js -o static/js/join.js -o static/js/legal.js -o static/js/media.js -o static/js/projects.js -o static/js/team.js ] -o static/js/common.js $(APPEND)
...
minify-js: install
	$(PREPEND)find static/js -name '*.js' -exec $(NPMBIN)/uglifyjs {} --compress --mangle --output {} $(APPEND) \;
...
dev: install js css
	$(PREPEND)( \
		$(NPMBIN)/watchify --noparse=jquery js/{about,blog,join,legal,media,projects,team}.js -p [ factor-bundle -o static/js/about.js -o static/js/blog.js -o static/js/join.js -o static/js/legal.js -o static/js/media.js -o static/js/projects.js -o static/js/team.js ] -o static/js/common.js & \
...
publish-to-domain: versions/current
		DNSIMPLE_TOKEN="$(shell if [ -f auth.token ]; then cat auth.token; else cat $$HOME/.protocol/dnsimple.protocol.ai.token; fi)" \
